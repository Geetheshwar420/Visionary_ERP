...
import { ArrowLeft, Activity, AlertTriangle, Sparkles, TrendingUp, DollarSign } from 'lucide-react';
...
const ProductDetails: React.FC<ProductDetailsProps> = ({ products, insights }) => {
            ...
            <div className="space-y-4">
              {productInsights.length > 0 ? (
                productInsights.map(insight => (
                  <div key={insight.id} className={`p-4 rounded-lg border relative overflow-hidden ${
                    insight.type === 'critical' ? 'bg-red-50 dark:bg-red-900/20 border-red-100 dark:border-red-800' : 
